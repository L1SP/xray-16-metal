...
public:
    ...
    adopt_compiler& _zbuffer(bool _test, bool _write) { C->PassSET_ZB(_test, _write); return *this; }
    ...
    adopt_compiler& _dx10ATOC(bool Enable)    { C->RS.SetRS(XRDX11RS_ALPHATOCOVERAGE, Enable); return *this; }
...
void CResourceManager::LS_Load()
{
    ...
    for (u32 it = 0; it < folder->size(); it++)
    {
        ...
        *strext(namesp) = 0;
        ...
        FS.update_path(fn, "$game_shaders$", shaderPath);
        xr_strcat(fn, (*folder)[it]);
