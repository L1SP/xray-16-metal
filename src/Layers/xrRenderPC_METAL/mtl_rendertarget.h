...
public:
    ...
    u32 t_noise_surf[TEX_jitter_count];
    ref_texture t_noise[TEX_jitter_count];
    u32 t_noise_surf_mipped;
...
private:
    ...
    MTL::RenderPipelineState* m_gamma_render_pso{};
...
public:
    ...
    u32 get_base_rt() { return rt_Base[HW.CurrentBackBuffer]->pRT; }
    u32 get_base_zb() { return rt_Base_Depth->pZRT; }
    ...
    void u_setrt(CBackend& cmd_list, u32 W, u32 H, u32 _1, u32 _2, u32 _3, u32 zb);
    void u_setrt(CBackend& cmd_list, u32 W, u32 H, u32 _1, u32 _2, u32 _3, const ref_rt& _zb)
    {
...
private:
    void _set_aref(u32 value);
    void _cl_point();
    void _cl_frustum(light* L);
};
} // namespace xray::render::RENDER_NAMESPACE
